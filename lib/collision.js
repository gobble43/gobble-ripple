...
// create a polygon (array of points) given a shape size and it's center point
...
// find if one user (lat, lng) is inside the polygon (array of lat, lng)
...
// find all the users (array of lat, lng) that are inside a polygon (array of lat, lng)
